...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['action'] ?? '') === 'send_message') {
    if (!verify_csrf($_POST['csrf_token'] ?? null)) {
        ...
        redirect('seller/conversation.php?property_id=' . max(0, $postPropertyId) . '&buyer_id=' . max(0, $postBuyerId));
    }
}
...
$page_description = 'Reply to a buyer inquiry on RealEstateAI.';
?>
...
<main id="main-content" class="admin-dashboard">
    <div class="container">
        <nav class="admin-breadcrumb" aria-label="Breadcrumb">
            ...
            <a href="<?php echo e(url('seller/messages.php')); ?>">Messages</a>
            <span aria-hidden="true">/</span>
        ...
        <?php if ($loadError !== null): ?>
            ...
            <a class="btn btn-outline-secondary" href="<?php echo e(url('seller/messages.php')); ?>">Back to messages</a>
        <?php elseif ($invalid || $context === null): ?>
            <div class="summary-panel">
                ...
                <a class="btn btn-auth" href="<?php echo e(url('seller/messages.php')); ?>">Back to messages</a>
            </div>
        <?php else: ?>
            <?php
            ...
            <div class="admin-hero d-flex flex-wrap justify-content-between align-items-start gap-3">
                ...
                <a class="btn btn-outline-secondary" href="<?php echo e(url('seller/messages.php')); ?>">All messages</a>
            </div>
