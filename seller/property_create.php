...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!verify_csrf($_POST['csrf_token'] ?? null)) {
        ...
        // Ignore any client-provided ownership or status fields.
        unset($_POST['listed_by_user_id'], $_POST['status'], $_POST['property_id']);
        ...
        if ($errors === []) {
            try {
                ...
                $stmt->execute([
                    $userId, // ownership from session only
                    $data['title'],
                    $data['description'],
                    $data['district'],
                    $data['area'],
                    ...
                    'PENDING', // Admin moderation before public availability
                ]);
                ...
                $pdo->commit();
                flash_set('success', 'Property submitted for Admin review (PENDING).');
...
$page_title = 'Add Property | RealEstateAI';
$page_description = 'Create a new RealEstateAI property listing.';
?>
...
<main id="main-content" class="admin-dashboard">
    <div class="container">
        ...
        <div class="admin-hero">
            ...
            <h1 class="admin-title">Add Property</h1>
            <p class="admin-welcome">New listings are saved as PENDING for Admin moderation.</p>
        </div>
        ...
        <div class="admin-form-card admin-form-card-wide">
            <form method="post" action="" enctype="multipart/form-data" novalidate>
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a class="btn btn-outline-secondary" href="<?php echo e(url('seller/properties.php')); ?>">Cancel</a>
                </div>
            </form>
        </div>
    </div>
