...
try {
    if ($predictionId <= 0) {
        ...
        $prediction = ai_admin_fetch_prediction(db(), $predictionId);
        if ($prediction === null) {
            $notFound = true;
        }
    }
...
$page_title = $notFound ? 'Prediction Not Found | RealEstateAI' : 'AI Prediction Details | RealEstateAI';
$page_description = 'Admin view of a recorded AI house price prediction.';
?>
...
<main id="main-content" class="admin-dashboard ai-prediction-detail-page">
    <div class="container">
        <nav class="admin-breadcrumb" aria-label="Breadcrumb">
            ...
            <a href="<?php echo e(url('admin/predictions.php')); ?>">AI Predictions</a>
            <span aria-hidden="true">/</span>
            <span>Details</span>
        </nav>
        ...
        <?php if ($loadError !== null): ?>
            ...
            <a class="btn btn-outline-secondary" href="<?php echo e(url('admin/predictions.php')); ?>">Back to AI Predictions</a>
        <?php elseif ($notFound || $prediction === null): ?>
            <div class="summary-panel">
                <h1 class="admin-title h3">Prediction not found</h1>
                <p class="empty-state">This prediction is unavailable or the ID is invalid.</p>
                <a class="btn btn-auth" href="<?php echo e(url('admin/predictions.php')); ?>">Back to AI Predictions</a>
            </div>
        <?php else: ?>
            <div class="admin-hero d-flex flex-wrap justify-content-between align-items-start gap-3">
                <div>
                    ...
                    <h1 class="admin-title">AI Prediction Details</h1>
                </div>
                <a class="btn btn-outline-secondary" href="<?php echo e(url('admin/predictions.php')); ?>">Back to AI Predictions</a>
            </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4">
                    <section class="summary-panel h-100">
                        <h2 class="summary-title">User Information</h2>
                        <dl class="detail-grid mb-0">
                            <div class="detail-span">
                                <dt>Full name</dt>
                                <dd><?php echo e((string) ($prediction['user_full_name'] ?? '—')); ?></dd>
                            </div>
                            <div class="detail-span">
                                <dt>Email</dt>
                                <dd><?php echo e((string) ($prediction['user_email'] ?? '—')); ?></dd>
                            </div>
                        </dl>
                    </section>
                </div>
                <div class="col-lg-8">
                    <section class="summary-panel h-100">
                        <h2 class="summary-title">Property Information</h2>
                        <dl class="detail-grid ai-prediction-detail-grid mb-0">
                            ...
                            <div class="detail-span"><dt>Prediction date/time</dt><dd><?php echo e(ai_format_prediction_datetime($prediction['created_at'] ?? null)); ?></dd></div>
                        </dl>
                    </section>
                </div>
            </div>
