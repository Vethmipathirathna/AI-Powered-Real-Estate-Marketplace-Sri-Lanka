...
try {
    ...
    $loadError = 'Unable to load your listing messages right now. Please try again later.';
}

$page_title = 'My Listing Messages | RealEstateAI';
$page_description = 'Buyer inquiries for properties you listed as Admin.';
?>
...
<main id="main-content" class="admin-dashboard">
    <div class="container">
        <nav class="admin-breadcrumb" aria-label="Breadcrumb">
            ...
            <span>My Listing Messages</span>
        </nav>

        <div class="admin-hero">
            <p class="admin-eyebrow">Admin lister inbox</p>
            <h1 class="admin-title">My Listing Messages</h1>
            <p class="admin-welcome">
                Private buyer conversations for properties you listed. This does not include messages for other listers' properties.
            </p>
        </div>
        ...
        <?php elseif ($summaries === []): ?>
            <div class="summary-panel">
                <p class="empty-state mb-0">No buyer messages for your own listings yet.</p>
            </div>
        <?php else: ?>
            <div class="message-inbox-list">
                <?php foreach ($summaries as $row): ?>
                    ...
                    $href = message_conversation_path_for_role('ADMIN', $propertyId, $buyerId);
                    ?>
